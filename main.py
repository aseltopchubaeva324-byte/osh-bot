...
# 🔐 ТОКЕН Render'ден келет
TOKEN = os.getenv("BOT_TOKEN")
ADMIN_ID = 1652310358  # Өз IDң
...
def get_news(lang):
    try:
        ...
        return result if result else "Жаңылык жок"
    except:
...
async def handle(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # АРЫЗ
        ...
        await update.message.reply_text("Сураныч, арызыңызды жазыңыз:")
        ...
        await update.message.reply_text("✅ Арызыңыз кабыл алынды. Жакында жооп берилет.")
