    ...
    if text in ["🏛 Мэрия жөнүндө", "🏛 О мэрии"]:
        if lang == "ru":
            msg = (
                ...
                "🌄 **Сулайман-Тоо:**\n"
                "Уникальная гора в центре города. Длина ~1140 м, ширина ~560 м.\n"
                "Имеет 5 вершин (самая высокая ~1175 м).\n\n"
                "🕌 **Особенности:**\n"
                "• Всемирное наследие ЮНЕСКО (2009)\n"
                "• Пещеры, петроглифы, мечети, музеи\n"
            ...
            msg = (
                ...
                "🌄 **Сулайман-Тоо:**\n"
                "Ош шаарынын так ортосунда жайгашкан уникалдуу тоо. Узундугу ~1140 м, туурасы ~560 м.\n"
                "5 чокусу бар (эң бийиги ~1175 м).\n\n"
                "🕌 **Өзгөчөлүктөрү:**\n"
                "• ЮНЕСКО дүйнөлүк мурасы (2009)\n"
                "• Үңкүрлөр, петроглифтер, мечиттер, музейлер\n"
                "• Байыркы мончо (XIV кылым)\n\n"
                "🏛 **Музей комплекси:**\n"
                "Сулайман-Тоо улуттук музейи – өлкөдөгү эң ири музейлердин бири.\n"
                "33 000+ экспонат сакталат.\n\n"
                "📚 **Экспозициялар:**\n"
                "• Археология, этнография, кол өнөрчүлүк\n\n"
                "📍 **География:** 870–1110 м бийиктикте жайгашкан.\n\n"
     ...
     # --- БАЙЛАНЫШ (КОНТАКТЫ) БӨЛҮМҮ ---
        ...
        if lang == "ru":
            ...
            msg = (
                ...
                "📌 Шаар куруу: 0 3222 5-53-79\n"
                "📌 Социалдык өнүгүү: 0 3222 5-53-06\n"
                "📌 Өзгөчө кырдаалдар: 0 3222 5-58-29\n"
                "📌 Шаардык чарба: 0 3222 5-53-34\n"
